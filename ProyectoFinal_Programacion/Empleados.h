...
public:
	...
	void crear() {
		...
		if (cn.getconectar()) {
			string insert =
				"INSERT INTO empleados(nombres, apellidos, direccion, telefono, dpi, genero, fecha_nacimiento, idpuesto, fecha_inicio_labores, fechaingreso)VALUES('"+ nombres +"', '"+ apellidos +"', '"+ direccion +"', '"+ t +"', '"+ DPI +"', "+ g +", '"+ fecha_nacimiento+ "', '"+ ip +"', '"+ fecha_inicio_labores +"', '"+ fechaingreso+ "');";
	...
	*/
	...
	void actualizar() {
		...
		if (cn.getconectar()) {
			string update = "update empleados SET nombres = '" + nombres + "', apellidos = '" + apellidos + "', direccion = '" + direccion + "', telefono = '" + te + "',dpi = '" + DPI + "', genero =" + ge + ", fecha_nacimiento = '" + fecha_nacimiento + "', idpuesto = " + ipu + ", fecha_inicio_labores = '" + fecha_inicio_labores + "', fechaingreso = '" + fechaingreso + "',where idempleado = " + i + ";";
